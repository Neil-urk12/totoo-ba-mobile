class MedicalDeviceIndustry {
  ...
  factory MedicalDeviceIndustry.fromJson(Map<String, dynamic> json) {
  ...
  MedicalDeviceIndustry copyWith({
...
enum MedicalDeviceIndustryStatus {
  active,
  expiringSoon,
  expired,
}

extension MedicalDeviceIndustryStatusExtension on MedicalDeviceIndustryStatus {
  String get displayName {
    switch (this) {
      case MedicalDeviceIndustryStatus.active:
        return 'Active';
      case MedicalDeviceIndustryStatus.expiringSoon:
        return 'Expiring Soon';
      case MedicalDeviceIndustryStatus.expired:
        return 'Expired';
    }
  }
